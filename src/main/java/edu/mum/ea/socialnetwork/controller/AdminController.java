...
public class AdminController {
    ...
    public ModelAndView getDeactivatedUsers() {
        ...
        List<UserDto> users = adminService.getDeactivatedUsers();
    ...
    public String toggleUser(@RequestBody String userId) {
    ...
    public String setUserRole(@RequestParam String userId, @RequestParam Role role) {
    ...
    public void processPost(@RequestParam String postId, @RequestParam boolean isApproved) {
